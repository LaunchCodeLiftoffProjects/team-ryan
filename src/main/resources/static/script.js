...
window.addEventListener("load", function(){
           let json = [];
           fetch("https://api.spoonacular.com/recipes/complexSearch?apiKey=3057efc6229646c8b0bda8fd922322a6&includeNutrition=true&cusine=true").then(function(response){
